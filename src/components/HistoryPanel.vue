<template>
  <div>
    ...
    <!-- 历史记录面板 -->
    <div 
      class="fixed right-0 top-0 h-full bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 max-w-[66.666667vw] w-96"
    ...
    >
      <div class="p-4 h-full flex flex-col relative">
        ...
        <button 
          @click="$emit('update:modelValue', false)"
          class="absolute right-4 top-4 w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 transition-colors"
        >
          <svg 
